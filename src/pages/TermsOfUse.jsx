...
const TermsOfUse = () => {
  return (
    <Container className='my-3'>
      ...
      <h4>Disclaimer</h4>
      <p>
        This website is maintained by the Forests & Environment Department,
        Government of Meghalaya.
      </p>
      <p>
        Though all efforts have been made to ensure the accuracy and currency of
        the content on this website, the same should not be construed as a
        statement of law or used for any legal purposes. Incase of any ambiguity
        or doubts, users are advised to verify/check with the Department and/or
        other sources, and to obtain appropriate professional advice.
      </p>
      <p>
        Under no circumstances will this Department be liable for any expense,
      ...
      <p>
        ...
        organizations. The Forests & Environment Department, Government of
        Meghalaya, is providing these links and pointers solely for your
        information and convenience. When you select a link to an outside
        website, you are leaving the, Forests & Environment Department,
        Government of Meghalaya, website and are subject to the privacy and
        security policies of the owners/sponsors of the outside website.
      </p>
      <p>
        Forests & Environment Department, Government of Meghalaya, does not
        guarantee the availability of such linked pages at all times.
      </p>
      <p>
        Forests & Environment Department, Government of Meghalaya, cannot
        authorize the use of copyrighted materials contained in linked websites.
        Users are advised to request such authorization from the owner of the
        linked website.
      </p>
      <p>
        Forests & Environment Department, does not guarantee that linked
        websites comply with Indian Government web Guidelines.
      </p>
      <h4>Copyright</h4>
      <p>
        Materials featured on this site may be reproduced free of charge in any
        format or media without requiring specific permission. This is subject
        to the material being reproduced accurately and not being used in a
        derogatory manner or in a misleading context. Where the material is
        being published or issued to others, the source must be prominently
        acknowledges. However, the permission to produce this material does not
        extent to any material on this site, which is explicitly identified as
      ...
      <p>
        ...
        Our Department pages must load into a newly opened browser window of the
        user.
      </p>
    </Container>
  )
