  ...
  return (
    <Container>
      ...
      <p>
        ...
        PLAN) has been prepared with the goal of ensuring sustained ecological
        security of the area and it will be implemented for a five-year period
        i.e from 2017-18 to 2021-22. It has been approved by APCCF (Wildlife) &
        Chief Wildlife Warden.
      </p>
      <p>
        Management plan of Narpuh Wildlife Sanctuary for period 2017-18 to
        2021-22 has also been approved.
      </p>
    </Container>
  )
}
