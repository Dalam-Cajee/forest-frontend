...
import { useFetchNotificationByID } from '../../hooks/queries/NotificationQueries'
...
const Home = () => {
  ...
  return (
    <div className='mb-3 bg-light'>
      ...
      <Carousel fade>
        <CarouselItem>
          <img src={umiam} className='w-100' />
          <CarouselCaption>
            <h4>Umiam Lake</h4>
          </CarouselCaption>
        </CarouselItem>
        <CarouselItem>
          <img src={gorge} className='w-100' />
          <CarouselCaption>
            <h4>Balpakram Gorge</h4>
          </CarouselCaption>
        </CarouselItem>
        <CarouselItem>
          <img src={park1} className='w-100' />
          <CarouselCaption>
            <h4>Lady Hydari Park</h4>
          </CarouselCaption>
        </CarouselItem>
        <CarouselItem>
          <img src={cherry} className='w-100' />
          <CarouselCaption>
            <h4>Cherry Blossom</h4>
          </CarouselCaption>
        </CarouselItem>
        <CarouselItem>
          <img src={lake} className='w-100' />
          <CarouselCaption>
            <h4>Ward's Lake</h4>
          </CarouselCaption>
        </CarouselItem>
        <CarouselItem>
          <img src={park2} className='w-100' />
          <CarouselCaption>
            <h4>Nehru Park</h4>
          </CarouselCaption>
        </CarouselItem>
        <CarouselItem>
          <img src={falls} className='w-100' />
          <CarouselCaption>
            ...
            <TabContainer defaultActiveKey='eService' className='mb-4'>
              ...
              <TabContent>
                ...
                >
                  ...
                  Tenetur laboriosam sed facere impedit veniam asperiores
                  perspiciatis at porro, quas totam quo et rem iure,
                  reprehenderit, eius necessitatibus ipsum velit.
                  Repudiandae.Lorem ipsum dolor sit amet consectetur adipisicing
                  elit. Tenetur laboriosam sed facere impedit veniam asperiores
                  perspiciatis at porro, quas totam quo et rem iure,
                  reprehenderit, eius necessitatibus ipsum velit. Repudiandae.
                </TabPane>
              </TabContent>
            </TabContainer>
          </Col>
