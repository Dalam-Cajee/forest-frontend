...
const ApplicationStatus = () => {
  ...
  const rangeApplications = useFetchApplicationsByRange(id, onSuccess, onError)
        ...
        <Row className="text-center">
          ...
          <div className="col-lg-3 p-4">
            <MyCardSP
              ...
              count={servicePlusStatus?.data?.data?.data?.submitted}
              // count={60}
            />
          </div>
          {/* Verified */}
          <div className="col-lg-3 p-4">
            <MyCardSP
              ...
              count={servicePlusStatus?.data?.data?.data?.delivered}
              // count={49}
            />
          </div>
          {/* Pending */}
          <div className="col-lg-3 p-4">
            <MyCardSP
              ...
              count={servicePlusStatus?.data?.data?.data?.pending}
              // count={9}
            />
          </div>
          {/* Rejected */}
          <div className="col-lg-3 p-4">
            <MyCardSP
              ...
              count={servicePlusStatus?.data?.data?.data?.rejected}
              // count={2}
            />
          </div>
        </Row>
