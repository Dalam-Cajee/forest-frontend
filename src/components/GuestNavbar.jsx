      ...
      <div className='container-fluid'>
        ...
        <NavbarCollapse id='responsive-navbar-nav'>
          <Nav className='me-auto '>
            ...
            <NavLink to="/social-forestry" className="nav-link text-white fw-bold">
              Social Forestry
            </NavLink>
            <NavLink to="/research-training" className="nav-link text-white fw-bold">
              Research & Training
            </NavLink>
            <NavLink to="/public-interface" className="nav-link text-white fw-bold">
              Public Interface
            </NavLink> */}
            <NavLink
              to='/notifications'
